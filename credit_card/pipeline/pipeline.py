...
from credit_card.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact,DataTransformArtifact,ModelArtifactConfig,ModelEvulationArtifact,ModelPusherArtifact
...
class Pipeline:
    ...
    def start_model_evulation(self,data_transform_artifact:DataTransformArtifact,
                              ...
                              data_validation_artifact : DataValidationArtifact)->ModelEvulationArtifact:
        try:
    ...
    def start_model_pusher(self,model_evulation_artifact:ModelArtifactConfig)->ModelPusherArtifact:
        try:
